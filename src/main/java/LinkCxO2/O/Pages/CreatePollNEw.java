...
//	@FindBy(xpath = "//android.view.ViewGroup[@content-desc=\"Business Growth   \"]/android.widget.CheckBox/com.horcrux.svg.SvgView/com.horcrux.svg.GroupView/com.horcrux.svg.RectView")
	...
	@FindBy(xpath = "(//com.horcrux.svg.PathView)[8]")
	private WebElement clickonVote;

	public void ClickonVoteOption() {
		action.clickElement(clickonVote);
	}

	@FindBy(xpath = "//android.widget.TextView[@text=\"Total Votes\"]")
	private WebElement verifyVoteGiven;

	public boolean VerifyVotedorNot() {
		return action.isDisplay(verifyVoteGiven);
	}
