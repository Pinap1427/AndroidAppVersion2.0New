...
public class CompanyCreateNewJob extends AbstractComponent{
	
	public CompanyCreateNewJob(AndroidDriver driver) throws Exception {
		super(driver);
...
//	testUtils1.test.log(Status.INFO, "Swipe down By Co Ordinates");
	...
	private WebElement JobsBtnCom;
	public void ClickonJobsbuttoninCompanyPage()
	{
	action.clickElement(JobsBtnCom);	
	}
	
	
	@FindBy(xpath = "//android.widget.TextView[@text=\"Create Job\"]")
	...
	public void EnterJobTitle() {
		action.sendKeysElement(jobTitle, "Project Manager");
	}
