...
public class CompantCreateEventNEw extends AbstractComponent{
	
	
	public CompantCreateEventNEw(AndroidDriver driver) throws Exception {
		super(driver);
...
//		testUtils1.test.log(Status.INFO, "Swipe down By Co Ordinates");
	...
	private WebElement EventBtnCom;
	public void ClickonEventbuttoninCompanyPage()
	{
	action.clickElement(EventBtnCom);	
	}
	
	
	@FindBy(xpath = "//android.view.ViewGroup[@content-desc=\"Create Event\"]/android.widget.TextView")
	private WebElement CreateEventBtn;
	public void ClickonCreateEventButton()
	{
		action.clickElement(CreateEventBtn);
	}
	...
	public void EnterEventTitle() {
		action.sendKeysElement(enterTitle, "1st year Anniversary Event ");
	}
	...
	String CompanyEvent ="We are excited to invite you to celebrate a milestone that is very close to our hearts – our company's first anniversary! Over the past year, we've grown, learned, and achieved so much, and it wouldn't have been possible without the support of our amazing team, clients, and partners. Join us for an evening of celebration, reflection, and looking forward to an even brighter future.\r\n"
			+ "We are excited to invite you to celebrate a milestone that is very close to our hearts – our company's first anniversary! Over the past year, we've grown, learned, and achieved so much, and it wouldn't have been possible without the support of our amazing team, clients, and partners. Join us for an evening of celebration, reflection, and looking forward to an even brighter future.";
...
//			+ "\r\n" + "Be there to witness history in the making.";
	...
	public void EnterEventDetails() {
		action.sendKeysElement(enterEventDet, CompanyEvent);
	}
	...
	@FindBy(xpath = "//android.view.ViewGroup[@content-desc=\"Offline\"]/android.widget.CheckBox")
	...
	@FindBy(xpath = "/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup/android.widget.ScrollView/android.view.ViewGroup/android.view.ViewGroup[4]")
	private WebElement toggleFreeBtn;
	public void ClickonToggleButton()
	{
		action.clickElement(toggleFreeBtn);
	}
	...
	// select Date
	@FindBy(xpath = "(//android.widget.EditText[@text=\"Select Date\"])[1]")
	...
	@FindBy(xpath = "//android.widget.RadialTimePickerView.RadialPickerTouchHelper[@content-desc=\"4\"]")
